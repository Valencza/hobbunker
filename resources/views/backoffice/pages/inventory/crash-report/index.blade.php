...
<div class="content flex-row-fluid" id="kt_content">
    ...
    <h3 class="pb-5">Laporan Kerusakan</h3>

    <section class="card mb-5 p-5">
        <form action="{{route('crash-report')}}" onchange="this.submit()">
            <div class="row">
    ...
    <section class="py-5 card p-4 rounded-3 shadow-sm">
        ...
        <table class="table table-row-dashed table-row-gray-300 gy-7">
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center">{{$crashReport->formatted_created_at}}</td>
                    <td class="text-center">{{$crashReport->masterUser->name}}</td>
                    <td class="text-center">{{$crashReport->title}}</td>
                    ...
                    <td class="text-center">
                        <a href="{{route('crash-report.detail', $crashReport->uuid)}}" class="btn btn-icon btn-light-primary rounded-circle text-light">
                            <i class="fa fa-eye"></i>
                        </a>
                    </td>
                </tr>
        ...
        {{$crashReports->links('vendor.pagination.bootstrap-5')}}

        {{-- empty --}}
        @if (count($crashReports) == 0)
