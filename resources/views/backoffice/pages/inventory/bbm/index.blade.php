...
<div class="content flex-row-fluid" id="kt_content">
    ...
    <h3 class="pb-5">Laporan BBM</h3>

    <section class="card mb-5 p-5">
        <form action="{{route('bbm-report')}}" onchange="this.submit()">
            <div class="row">
    ...
    <section class="py-5 card p-4 rounded-3 shadow-sm">
        ...
        <table class="table table-row-dashed table-row-gray-300 gy-7">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $item->masterUser->name ?? 'Null' }}</td>
                    <td class="text-center">{{ $item->masterShip->name ?? 'Null' }}</td>
                    <td class="text-center">{{ $item->masterMeachine->name ?? 'Null' }}</td>
                    <td class="text-center">{{$item->start}}</td>
                    <td class="text-center">{{$item->stop}}</td>
        ...
        {{$bbm->links('vendor.pagination.bootstrap-5')}}
