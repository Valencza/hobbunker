...
<div class="content flex-row-fluid" id="kt_content">
    ...
    <h3 class="pb-5">Laporan Inventaris</h3>

    <section class="card mb-5 p-5">
        <form action="{{route('inventory-report')}}" onchange="this.submit()">
            <div class="row">
        ...
        <table class="table table-row-dashed table-row-gray-300 gy-7">
            <thead>
                <tr class="fw-bolder fs-6 text-gray-800">
                    ...
                    <th class="text-center">Sisa Inventaris</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{route('inventory-report.detail', [
