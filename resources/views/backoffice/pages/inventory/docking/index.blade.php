...
<div class="content flex-row-fluid" id="kt_content">
    ...
    <h3 class="pb-5">Laporan Docking</h3>

    <section class="card mb-5 p-5">
        <form action="{{route('docking-report')}}" onchange="this.submit()">
            <div class="row">
    ...
    <section class="py-5 card p-4 rounded-3 shadow-sm">
        ...
        <table class="table table-row-dashed table-row-gray-300 gy-7">
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center">{{$docking->formatted_created_at}}</td>
                    <td class="text-center">{{$docking->title}}</td>
                    <td class="text-center">{{ucwords($docking->type)}}</td>
                    <td class="text-center">{{$docking->description}}</td>
                    <td class="text-center">
                        <a href="{{route('docking-report.detail', $docking->uuid)}}" class="btn btn-icon btn-light-primary rounded-circle text-light">
                            <i class="fa fa-eye"></i>
                        </a>
                    </td>
                </tr>
        ...
        {{$dockings->links('vendor.pagination.bootstrap-5')}}
