...
@section('content')
    <main class="content flex-row-fluid">
        ...
        <section class="card shadow-sm rounded-2xl mb-3">
            ...
            <div class="px-4 py-3">
                ...
                <p class="pb-4 font-medium mt-2">{{$docking->title}}</p>

                <h4 class="mb-1">Tipe Docking</h4>
                <p class="pb-4 font-medium mt-2x">{{ucwords($docking->type)}}</p>

                <h4 class="mb-1 text-capitalize">Keterangan</h4>
                <p class="pb-4 font-medium mt-2">{{$docking->description}}</p>
