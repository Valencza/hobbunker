...
<div class="content flex-row-fluid" id="kt_content">
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        <!--begin::Item-->
        <li class="breadcrumb-inspection text-gray-600">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-inspection text-gray-500">Laporan</li>
        <!--end::Item-->
    </ul>
    {{--        end breaddcrumb --}}

    <h3 class="pb-5">Laporan Inspeksi Kapal</h3>

    <section class="card mb-5 p-5">
        <form action="{{route('inspection-report')}}" onchange="this.submit()">
            <div class="row">
    ...
    <section class="py-5 card p-4 rounded-3 shadow-sm">
        <div class="d-flex align-inspections-center justify-content-between px-5">
            <h3>Daftar Inspeksi Kapal</h3>
            <div class="w-25">
                {{-- search form --}}
        ...
        <table class="table table-row-dashed table-row-gray-300 gy-7">
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center">{{$inspection->formatted_created_at}}</td>
                    <td class="text-center">{{$inspection->formatted_date}}</td>
                    <td class="text-center">{{$inspection->masterUser->name}}</td>
                    <td class="text-center">{{$inspection->masterShip->name}}</td>
                    <td class="text-center">
                        <a href="{{route('inspection-report.detail', $inspection->uuid)}}" class="btn btn-icon rounded-circle btn-light-primary">
                            <i class="fa fa-eye"></i>
                        </a>
                    </td>
                </tr>
        ...
        {{$inspections->links('vendor.pagination.bootstrap-5')}}
