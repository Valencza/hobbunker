        ...
        <main style="width: 100vw;">
            <table>
                <tr>
                    ...
                    <td style="width: 100%; text-align: right">
                        <div>
                            <h3 style="font-size: 15px">DAFTAR CUTI KARYAWAN PT. HARPA OCEAN BERSAMA</h3>
                            <table>
                                <tr>
            ...
            <table border="1" cellspacing="0" cellpadding="5" style="margin: auto; margin-top: 50px; width: 100%">
                ...
                <tr>
                    ...
                    <td style="text-align: center">{{$user->masterRole->name}}</td>
                    <td style="text-align: center"><span>{{$user->leave_request}}{{$user->leave_request}}</span> / {{$countLeaveBalanceYear}}</td>
