...
<main class="p-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5 mt-3">
        <h2 class="anchor">Stok Kantor</h2>
        <div>
            <a href="{{route('stock-inventory-office.stock.create')}}" class="btn btn-primary d-flex gap-1 align-items-center">
    ...
    <section class="card shadow-sm p-4 rounded-2xl">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="fs-4">Daftar Stok</h2>
            <a href="{{route('stock-inventory-office.stock.export')}}"
        ...
        <div class="d-flex flex-column gap-3 mb-5">
            ...
            <a href="{{route('stock-inventory-office.stock.detail', $masterItem->uuid)}}"
                ...
                <div class="d-flex flex-column w-100">
                    <span class="fw-medium fs-5 p-0 mb-3">{{$masterItem->name}}</span>
                    <div>
                ...
                <div class="d-flex flex-column justify-content-end w-50 text-end">
                    <div>
                        <h2 class="fw-bolder">{{$masterItem->officeStockHistory->total}}</h2>
