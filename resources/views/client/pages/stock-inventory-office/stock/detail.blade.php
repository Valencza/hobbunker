...
<main class="p-4">
    ...
    <h2 class="anchor mb-5 mt-3">Detail Stok</h2>
            ...
            <div class="row pb-2">
                <div class="col-12">
                    <div class="card h-100 bg-body-secondary p-3 rounded-3 my-2">
                        ...
                        <h4 class="text-secondary">Sisa Stock</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="card shadow-sm p-4 rounded-2xl">
        <div class="d-flex justify-content-between">
            <h2 class="fs-4 mb-3 ">Daftar Stok</h2>
        </div>
        ...
        <div class="d-flex flex-column gap-3 mb-5">
            ...
            <div
                ...
                <a href="{{route('stock-inventory-office.stock.scan', $officeStock->uuid)}}">
    ...
    <section class="card shadow-sm p-4 rounded-2xl mt-4">
        <div class="d-flex justify-content-between">
            <h2 class="fs-4 mb-3 ">Riwayat Stok</h2>
        </div>
    ...
    <section class="card shadow-sm p-4 rounded-2xl mt-4">
        <div class="d-flex justify-content-between">
            <h2 class="fs-4 mb-3 ">Pemakaian Stok</h2>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4" style="height: 300px; overflow-x: auto;">
                    <form id="use-form" action="{{route('stock-inventory-office.stock.use', $masterItem->uuid)}}"
                        method="POST">
                        @csrf
                        ...
                        <div id="item-use-{{$officeStock->code}}"
                            onclick="toggleDelete('{{$officeStock->code}}', 'use')"
    ...
    <div class="modal fade" id="deleteStockModal" tabindex="-1" aria-labelledby="deleteStockModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4" style="height: 300px; overflow-x: auto;">
                    <form id="delete-form" action="{{route('stock-inventory-office.stock.update', $masterItem->uuid)}}"
                        method="POST">
                        @csrf
                        <input type="hidden" name="codes" id="delete-codes">

                        @foreach ($officeStocksAll as $officeStock)
                        <div id="item-delete-{{$officeStock->code}}"
                            onclick="toggleDelete('{{$officeStock->code}}', 'delete')"
                            class="card border-1 border-dashed rounded-2xl d-flex gap-3 flex-row justify-content-between align-items-center py-2 px-3 mb-3 cursor-pointer">
                            <div class="centering bg-light-primary rounded p-3">
                                <span class="text-primary fw-bolder">
                                    <x-acronym text="{{$masterItem->name}}"></x-acronym>
