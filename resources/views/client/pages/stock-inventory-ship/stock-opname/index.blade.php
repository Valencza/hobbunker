...
<main class="p-4">
    ...
    <h2 class="anchor mb-5 mt-3">Stok Opname</h2>

    <section class="row gap-3 mb-5 px-3">
        <a href="{{route('stock-inventory-ship.request-item', [ $masterShip->uuid, 'stok'])}}" class="col card px-2 py-2 rounded-2xl shadow-sm d-flex flex-column gap-2 text-decoration-none">
            <img src="{{ asset('assets/media/illustrations/icon_permintaan_barang.webp') }}" class="h-75" alt="">
            <span class="text-muted text-center text-dark fw-bolder fs-6">Permintaan Stok</span>
        </a>
        <a href="{{route('stock-inventory-ship.used-item', $masterShip->uuid)}}" class="col card px-2 py-2 rounded-2xl shadow-sm d-flex flex-column gap-2 text-decoration-none">
            <img src="{{ asset('assets/media/illustrations/icon_pemakaian_barang.webp') }}" class="h-75" alt="">
            <span class="text-muted text-center text-dark fw-bolder fs-6 w-100">Pemakaian Barang</span>
        </a>
    </section>

    <a href="{{route('stock-inventory-ship.stock.create')}}" class="btn btn-primary w-100 mb-3">
        Tambah Stok
    </a>

    <section class="card shadow-sm p-4 rounded-2xl mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="fs-4 mb-3">Stok Mesin</h2>
    ...
    <section class="card shadow-sm p-4 rounded-2xl">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="fs-4 mb-3">Stok Dek</h2>
