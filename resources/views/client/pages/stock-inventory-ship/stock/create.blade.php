...
@section('title', 'Tambah Stok Kapal')
...
<main class="p-4">
    ...
    <h2 class="anchor mb-5 mt-5">Stok Kapal</h2>
        ...
        <form method="POST" class="px-4">
            ...
            <div class="mb-10">
                ...
                <input type="text" id="check_master_item" class="form-control d-none"
                    placeholder="Masukkan nama stok lainnya">
            </div>
            ...
            <div class="align-items-center mt-3 mb-10">
                ...
                <label for="other_item">Stok Lainnya</label>
            </div>
            <div class="mb-10">
    ...
    $('#submit-btn').click(function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                localStorage.setItem('ship-stock-date', JSON.stringify(date));
                localStorage.setItem('ship-stocks', JSON.stringify(items));
                document.location.href = "{{route('stock-inventory-ship.stock.barcode')}}"
            }
        });
    });
